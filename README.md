...
Dedicated to Maxime, to help keep her memory alive.
...
*   ![light-theme](assets/icons/sun-fill.svg "Light theme") or ![dark-theme](assets/icons/moon-stars-fill.svg "Dark theme") is used for switching the theme (dark or light). This automatically tries to match with your computer's theme.
